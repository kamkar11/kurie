...
<div class="table-responsive-md">
  ...
  <?php
   ...
   <tr>
       ...
       <td>
          <a href="index.php?v=magazyny/edit_magazyn&id=<?php echo $magazyny['ID_MAGAZYNU']; ?>" class="btn btn-success">Edytuj</a>

        </td>
       <td>
          <a onclick="return confirm('Usunąć ten rekord?')" href="index.php?v=magazyny/delete_magazyn&id=<?php echo $magazyny['ID_MAGAZYNU']; ?>" class="btn btn-danger">Usuń</a>
